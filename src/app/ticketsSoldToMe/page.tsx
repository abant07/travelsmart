    ...
    React.useEffect(() => {
        ...
        const getTicketInfo = async (account: string) => {
            ...
            for (let i = 0; i < boxNames.length; i++) {
              ...
              if (decodedBoxValue[12] == account && decodedBoxValue[11] != account && decodedBoxValue[13] == "transfer") {
                decode.push(string)
                ...
                decode.push(decodedBoxValue[8])
                decode.push(decodedBoxValue[9])
        ...
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            ...
            <div className="mt-2 text-center">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">
                    Tickets Selling to You
                </h2>
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                    View and buy tickets that want to be transferred to you from other sellers
                </p>
            </div>
            ...
            <div className="mb-32 mt-20 grid gap-10 text-center lg:w-full lg:max-w-6xl lg:grid-cols-3 lg:text-left justify-items-center">
                {decodedValues.filter(value =>
                    ...
                    String(value[2]).toLowerCase().includes(filter2.toLowerCase()) &&
                ...
                <div className="bg-white dark:bg-zinc-800 rounded-lg p-8 shadow-lg border dark:border-neutral-800 w-full max-w-md mx-4">
                    ...
                    {decodedValues.filter(value => value[0] === selectedTicket).map((value, index) => (
                        ...
                        <div className="text-gray-700 dark:text-gray-300 mb-4">
                            ...
                            <p><strong>Ticket Seller:</strong> {value[9]} {value[10]}</p>
                        </div>
                        <button
