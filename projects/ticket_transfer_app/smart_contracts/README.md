...
By the default the template creates a single `HelloWorld` contract under airline_ticket_transfer folder in the `smart_contracts` directory. To add a new contract:
